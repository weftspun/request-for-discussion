# RFD 0079: AppSignal observability, and versitygw's removal
...
`flyctl logs`. Separately, RFD 0073's `versitygw` (RFD 0058's
S3-API gateway) sat unused: RFD 0073 (weftspun/request-for-discussion)
and RFD 0077 already decided Tigris replaces it, and RFD 0076 split
...
RFD 0073 and RFD 0077 (both weftspun/request-for-discussion) decide
Tigris over `versitygw`. RFD 0076 gives the `apps/` split that made
