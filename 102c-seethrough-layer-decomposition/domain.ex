...
# RFD 102c records why this pipeline is a domain and not a script.
#
# Nine networks. RFD 101e lists them with their memory. The guards
...
defmodule SeethroughLayerDecomposition do
  ...
  @variables %{
    ...
    # Which component is resident. RFD 101b caps the total.
    loaded: %{
      type: :bool,
      init: %{
        lama: false,
