"""See-Through layer decomposition. RFD 102c.

Nine networks. RFD 101e lists them, and domain.ex orders them.
...
The planner is taskweft. See RFD 1025.
"""
...
class Predictor(BasePredictor):
    ...
    def _replan(self, plan: list[list], fail_step: int) -> list[list]:
        ...
        does not repeat the diffusion. RFD 1025 records that this is
