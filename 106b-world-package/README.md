# RFD 106b: The world package format, splats plus optional props
...
(RFD 1064), since a splat-only world has no mesh props to publish
there at all.
...
reconciliation is still open. RFD 1064 gives the separate spatial
