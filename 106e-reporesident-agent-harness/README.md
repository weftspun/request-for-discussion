# RFD 106e: RepoResident, a file-based operating harness for coding agents
...
RFD 1056 gives the Surface/DGX topology `PROJECT.md`'s sync-ownership
rule depends on. RFD 1063 gives the operator command cheat sheet this
