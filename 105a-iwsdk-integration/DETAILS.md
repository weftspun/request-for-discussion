# RFD 105a details: packages, tooling, controls, and the work order
...
HTTPS is required for on-device WebXR (RFD 1058).
...
3. Test WebXR on Galaxy XR's own Chrome, on device (HTTPS required; RFD 1058).
...
`https://<PC-LAN-IP>:3000/?nativeFaceRelay=1` (RFD 1069).
