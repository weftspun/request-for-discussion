# RFD 105a: IWSDK, a separate `/xr` lab, Galaxy XR as the source of truth
...
that reconciliation is still open. RFD 1058 gives the HTTPS setup
WebXR needs on a device. RFD 1069 gives the webcam and native
