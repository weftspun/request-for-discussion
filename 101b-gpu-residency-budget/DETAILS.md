# RFD 101b details: the tier table, staging, quantization, what to do
...
RFD 102c makes the load and the unload real actions, thus the peak is
a planning result.
...
Measure the quality cost before the catalog depends on it. RFD 102b
