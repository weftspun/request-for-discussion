...
Two numbers decide the tier: the weights RFD 101a gives per model,
...
RFD 1019 gives the arithmetic. RFD 101a gives the memory per model.
RFD 1024 gives the packaging that sets the tier.
