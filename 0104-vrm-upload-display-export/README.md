# RFD 0104: Uploaded VRM, rotate the scene root, never the hips
...
RFD 0083 gives the AIGC rig contract this upload path deliberately
does not run. RFD 0084 gives the avatar pipeline that path serves
instead.
