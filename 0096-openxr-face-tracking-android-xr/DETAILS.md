# RFD 0096 details: references, payload contract, and mapping fidelity
...
(the webcam driver, RFD 0105, is deliberately off during WebXR).
...
RFD 0082 gives the full APK design this relay depends on.
