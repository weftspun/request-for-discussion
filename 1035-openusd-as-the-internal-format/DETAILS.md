# RFD 1035 details: layers, the boundary, the runtime, the model image contract
...
Elixir core from RFD 1013 links the same USD build the model images write.
...
RFD 1024 records this in the model image convention.
