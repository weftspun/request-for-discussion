# RFD 0107: The world package format, splats plus optional props
...
(RFD 0100), since a splat-only world has no mesh props to publish
there at all.
...
reconciliation is still open. RFD 0100 gives the separate spatial
