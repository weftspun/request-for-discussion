# RFD 104f: AppSignal observability, and versitygw's removal
...
`flyctl logs`. Separately, RFD 1049's `versitygw` (RFD 103a's
S3-API gateway) sat unused: RFD 1049 (weftspun/request-for-discussion)
and RFD 104d already decided Tigris replaces it, and RFD 104c split
...
RFD 1049 and RFD 104d (both weftspun/request-for-discussion) decide
Tigris over `versitygw`. RFD 104c gives the `apps/` split that made
