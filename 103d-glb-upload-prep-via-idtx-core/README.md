# RFD 103d: GLB upload prep moves to idtx_core, later
...
written. RFD 1017 first recorded this gap, and it stayed open
through RFD 103c's move.
...
and WebP. RFD 1035 makes OpenUSD the internal format, the way
...
RFD 1017 first recorded the `prepareGlbForApiUpload` gap. RFD 1035
selects OpenUSD as the internal format this RFD defends. RFD 1039
