# RFD 103d details: what idtx_core carries, the path there, the stopgap, a bug
...
is RFD 1039-style open work, not a task this RFD's Decision closes.

## The interim stopgap, in `glbCompress.js` today

This stopgap works in GLB, against RFD 1035's own rule that GLB
