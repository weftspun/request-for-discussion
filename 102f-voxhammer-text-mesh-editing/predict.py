"""VoxHammer text mesh editing. RFD 102f.

No weights of its own. The TRELLIS.2 backbone from RFD 1026 comes
from the base image.
...
layer and gets the original back. RFD 1035 gives that rule.
"""
