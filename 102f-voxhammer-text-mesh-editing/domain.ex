...
# RFD 102f records why this is a domain and not a script.
#
# The model carries no weights of its own. It runs on the TRELLIS.2
# backbone from RFD 1026.
#
...
defmodule VoxhammerMeshEditing do
  ...
  @variables %{
    ...
    # RFD 102f is text, and RFD 1030 is image. One domain serves both.
    mode: %{
      type: :ref,
  ...
  @actions %{
    ...
    # RFD 1035 gives the rule. A muted layer returns the original.
    a_write_layer: %{
      params: [],
      body: [
