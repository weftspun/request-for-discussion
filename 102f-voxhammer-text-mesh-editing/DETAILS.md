# RFD 102f details: the model, the interface, the guard, layering
...
`region` is a mask. RFD 101c records the supported mask list in
...
RFD 1035 gives the rule. The edit is a sublayer over the source mesh,
