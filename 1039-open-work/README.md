...
RFD 1037 selects the host. RFD 1038 selects the development system.
RFD 1024 packages the models. RFD 101a holds the memory numbers.

RFD 103a gives the Quadlet deployment. RFD 103b gives the one-step
build. RFD 103d gives the `idtx_core` upload-prep decision. RFD 103e
