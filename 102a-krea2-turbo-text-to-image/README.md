# RFD 102a: Model image for krea2_turbo_text_to_image
...
Quantize to Q4_K_M. RFD 101b selects that format for both
...
RFD 101b selects the format. RFD 1022 checks the arithmetic. RFD 1019
gives the rule.
