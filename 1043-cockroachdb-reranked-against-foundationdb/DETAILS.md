# RFD 1043 details: the sibling repositories, and what each found

## The decision as published, and its three reasons

Keep CockroachDB. RFD 1014 stands.
...
records, and RFD 1041's trait ids, not an MMO's tick-rate traffic.
...
of those costs. RFD 103a grounds its whole zero-trust design in
predictable, boring processes. RFD 103b asks for a build that runs
...
RFD 1014 already accepts pinning one tag deliberately. Track this in
RFD 1039's open work. Revisit it if the fork stays dark long enough
