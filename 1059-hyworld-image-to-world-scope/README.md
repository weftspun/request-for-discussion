# RFD 1059: HY-World 2.0, a quality path beside the fast one
...
RFD 106b gives the world-manifest contract this pipeline extends to
a version 2. RFD 105e gives WorldMirror 2.0, the reconstruction path
