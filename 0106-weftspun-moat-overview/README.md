# RFD 0106: The open/proprietary boundary, in public words
...
in this project's own `README.md` and `TRADEMARKS`. RFD 0109 gives
the payment-rail and phygital-registry areas this page's own source
document once listed; both are abandoned, per RFD 0012 and RFD
