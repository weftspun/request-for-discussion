# RFD 0106 details: the proprietary-area table and the architecture split
...
this table. RFD 0109 gives why: both are abandoned, per RFD 0012 and
RFD 0015, and both were fully stripped from the codebase before this
