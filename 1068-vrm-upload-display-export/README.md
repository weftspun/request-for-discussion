# RFD 1068: Uploaded VRM, rotate the scene root, never the hips
...
RFD 1053 gives the AIGC rig contract this upload path deliberately
does not run. RFD 1054 gives the avatar pipeline that path serves
instead.
