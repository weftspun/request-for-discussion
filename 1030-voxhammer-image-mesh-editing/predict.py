"""VoxHammer image mesh editing. RFD 1030.

The image variant of RFD 102f. Every stage is shared, and only the
conditioning differs.

The domain lives in the RFD 102f folder, because two copies would
