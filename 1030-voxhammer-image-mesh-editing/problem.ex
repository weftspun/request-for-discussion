...
#
# The domain is shared with RFD 102f. Only the conditioning changes,
# thus this file sets mode and nothing else. RFD 1030 records why one
...
defmodule VoxhammerImageEditOne do
  ...
  @variables %{
    ...
    # The one line that differs from RFD 102f. apply_edit checks this
