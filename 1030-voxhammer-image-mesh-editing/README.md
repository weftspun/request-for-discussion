# RFD 1030: Model image for voxhammer_image_mesh_editing
...
This is the image variant of RFD 102f. It edits a mesh region from a
...
Share the domain with RFD 102f. `voxhammer_mesh_editing` in
