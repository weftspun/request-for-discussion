...
#
# Solved from the RFD 102f domain, with problem.ex here supplying
...
defmodule VoxhammerImageMeshEditingPlan do
  ...
  # 7 steps, and one differs from RFD 102f. apply_edit took its :image
  # alternative here. That is the evidence for the RFD 1030 claim that
