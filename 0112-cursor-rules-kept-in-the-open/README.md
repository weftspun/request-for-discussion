...
`dgx-sync-reminder.mdc` stay too, unedited: RFD 0106 gives the
...
RFD 0000 names the DRY policy this RFD sets aside for a process
rule, and restores once a guard rule converts. RFD 0106 gives the
