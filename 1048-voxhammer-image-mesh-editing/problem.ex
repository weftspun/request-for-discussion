...
#
# The domain is shared with RFD 1047. Only the conditioning changes,
# thus this file sets mode and nothing else. RFD 1048 records why one
...
defmodule VoxhammerImageEditOne do
  ...
  @variables %{
    ...
    # The one line that differs from RFD 1047. apply_edit checks this
