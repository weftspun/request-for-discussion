...
#
# Solved from the RFD 1047 domain, with problem.ex here supplying
...
defmodule VoxhammerImageMeshEditingPlan do
  ...
  # 7 steps, and one differs from RFD 1047. apply_edit took its :image
  # alternative here. That is the evidence for the RFD 1048 claim that
