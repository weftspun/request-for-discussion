# RFD 1019 details: shape, phases, compute, ports, packaging, risk, references
...
the source. A build step writes the JavaScript catalog, and RFD 1016
needs an update at that point.

Later phases take the job lifecycle from RFD 1003, then the pipeline
graph from RFD 1002. A phase ends only after the parity check
...
model. A benchmark moves a recommendation. RFD 1016 records that
