# RFD 101a: bf16 memory per model
...
Apply the rule from RFD 1019 to each catalog model. Treat the
estimated rows as an upper bound for planning.

RFD 101b permits two formats. bf16 holds one parameter in 2 bytes, and
...
RFD 1019 gives the arithmetic. RFD 101b gives the totals and the
consequence. RFD 101e breaks down the See-Through row.
