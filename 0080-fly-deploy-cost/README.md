# RFD 0080: What the three Fly deploys cost
...
before per-GB billing), and any future Tigris usage RFD 0073's
still-open fetch-path work would add.

## Related

RFD 0062 gives the Fly.io toplevel. RFD 0076 gives the `apps/` split
across three Fly apps. RFD 0079 gives `versitygw`'s removal, no
