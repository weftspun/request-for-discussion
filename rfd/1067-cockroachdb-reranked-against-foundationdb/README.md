# RFD 1067: CockroachDB, reranked against FoundationDB
...
RFD 1020 picked CockroachDB before sibling `weftspun` repositories
...
This RFD published "keep CockroachDB, RFD 1020 stands." That decision
...
RFD 1020 picks CockroachDB. RFD 1058 and RFD 1059 state the
zero-trust, one-command build. RFD 1065's taxonomy runs on
CockroachDB in `character_taxonomy/`. RFD 1057 gets the dead-fork
