...
RFD 1016 inventories fifteen, drawn from `src/library/aiModelsCatalog.js` -- the
...
means RFD 1038 and RFD 1039 package models nothing now plans to convert.
...
neither appeared in RFD 1016 nor as a `<project>` anywhere. They were not missing
...
RFD 1133 carries them, and this document does not restate the rows. It was split
...
**RFD 1016 is missing eight models that are checked out**, three on this goal and
