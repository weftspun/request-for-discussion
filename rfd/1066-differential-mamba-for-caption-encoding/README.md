# RFD 1066: Differential Mamba for caption encoding

**State:** abandoned
**Scope:** RFD 1065's trait resolve step
...
1065's resolve step needs none of that. `HRR.encode_atom/2` is a
...
RFD 1021 already chose this closed-form algebra over a trained model,
...
RFD 1065 resolves a dataset caption to a trait capability id through
...
RFD 1065 owns the resolve step this RFD examined. RFD 1021 gives the
