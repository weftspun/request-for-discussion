# RFD 1094 details: current state, the three phases, and testing
...
on a rigged body. RFD 1084 gives the optional splat preview on
avatar-from-image. RFD 1083 gives the rig contract a mesh's own
