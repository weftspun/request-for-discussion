"""VoxHammer image mesh editing. RFD 1048.

The image variant of RFD 1047. Every stage is shared, and only the
conditioning differs.

The domain lives in the RFD 1047 folder, because two copies would
