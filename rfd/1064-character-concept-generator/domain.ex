...
# RFD 1064 records why this pipeline is a domain and not a script.
# RFD 1065 records the schema this file follows.
#
# `trait` and `numeric` hold one value per character, per RFD 1065's
