# RFD 1090: IWSDK, a separate `/xr` lab, Galaxy XR as the source of truth
...
that reconciliation is still open. RFD 1088 gives the HTTPS setup
WebXR needs on a device. RFD 1105 gives the webcam and native
