# RFD 103a details: the mechanisms, ZooKeeper, images, migration, boot bugs, deploy, verification
...
RFD 1049 puts this to work, on the Fly toplevel: `versitygw` runs
...
each one down and rebuilds it from the image. RFD 1025's taskweft
...
`WeftspunStudio.Application`. Neither ran before this RFD. RFD 1039
...
future rebuild, the same caution RFD 1039 gives the dev container
