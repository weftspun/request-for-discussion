...
7. **The mesh is rung one, not the destination.** The ladder ends at a clothed character, and
   garment layers come from geometry rather than inference. See `DETAILS.md` and RFD 1079.

## Related

RFD 1079 gives the layer route, RFD 101c the licence gate, RFD 1010 the model catalog.
