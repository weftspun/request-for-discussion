# RFD 106f: The 3DAIGC-API reference, not restated here
...
source stays correct. RFD 1055 already made this same call for the
...
RFD 1055 gives the same DRY call for the browser client's own
module map. RFD 1066 gives the task catalog a client developer needs
day to day. RFD 1064 gives the spatial-fabric publish path this
