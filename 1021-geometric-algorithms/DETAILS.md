# RFD 1021 details: the algorithm table, scaling, license note
...
Each one is packaged as its own model image, per RFD 1024.
...
quadwild_retopology uses the GPL-3 license, which RFD 101c excludes.
Instant Meshes is the permissive replacement, and RFD 101d records the
other options.
