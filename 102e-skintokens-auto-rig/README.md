# RFD 102e: Model image for skintokens_auto_rig
...
A rig is the clearest case for RFD 1035. The rig is an opinion about
...
RFD 1035 gives the layer rule. RFD 1023 records the template rig
split. RFD 1005 records the VRM pipeline.
