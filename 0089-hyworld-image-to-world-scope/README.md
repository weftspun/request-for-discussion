# RFD 0089: HY-World 2.0, a quality path beside the fast one
...
RFD 0107 gives the world-manifest contract this pipeline extends to
a version 2. RFD 0094 gives WorldMirror 2.0, the reconstruction path
