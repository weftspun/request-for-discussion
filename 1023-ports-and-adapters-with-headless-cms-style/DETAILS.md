...
| ----------------------------- | -------- | ------------------------- |
| Which models exist            | Yes      | `CatalogSource`, RFD 1022 |
...
Red, green, refactor, as RFD 1022 sets out. The RFD is the first red.
...
predate the rebrand, and RFD 1022 records them. The Status section
...
- `src/components/TaskManager.jsx` line 1163 imports
  `prepareGlbForApiUpload` from `glbCompress.js`. RFD 1061 later
