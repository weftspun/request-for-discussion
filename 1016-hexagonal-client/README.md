# RFD 1016: A hexagonal client for the headless studio API
...
RFD 1013 makes the studio core an API server. The browser client
...
list, from RFD 1010. The two already drifted once:
