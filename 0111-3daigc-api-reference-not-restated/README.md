# RFD 0111: The 3DAIGC-API reference, not restated here
...
spatial-fabric publish path. RFD 0000's DRY policy forbids a copy of
source documentation in this repository, since a copy drifts and the
source stays correct. RFD 0085 already made this same call for the
...
RFD 0085 gives the same DRY call for the browser client's own
module map. RFD 0102 gives the task catalog a client developer needs
day to day. RFD 0100 gives the spatial-fabric publish path this
