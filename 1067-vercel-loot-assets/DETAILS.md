# RFD 1067 details: dashboard setup, URL layout, verification, and the alternative
...
RFD 1062 gives the full public-build security checklist this
...
deploy with no external CDN dependency, RFD 105d's own default mode.
