# RFD 1067: Loot assets from a CDN, not a full clone, on Vercel
...
RFD 105d's default asset fetch clones the full `m3-org/loot-assets`
...
bundled, full-clone mode RFD 105d gives.
...
RFD 105d gives the bundled-clone default this RFD's CDN mode
replaces. RFD 1062 gives the public-build secret checklist this RFD
also names.
