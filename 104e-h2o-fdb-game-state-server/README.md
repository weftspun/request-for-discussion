# RFD 104e: An H2O/FoundationDB game-state server
...
RFD 104d gives the CDN question that raised this one. RFD 103d and
RFD 103e name `multiplayer-fabric-godot` as the asset-streaming
