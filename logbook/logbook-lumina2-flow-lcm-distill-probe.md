...
pair was seen 100 times, inverting LCM's "large-n, few-epoch" recipe
(Luo et al 2023 run ~1 epoch over millions of samples). The n=1000
scale-up runs 2 epochs, so each pair is seen twice, matching the
shape LCM actually needs.
