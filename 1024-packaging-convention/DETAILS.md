...
RFD 101b records that every model in the catalog reaches a 24 GB card.
...
- Return a USD layer beside the transmission file. RFD 1035 gives that
  rule.
- Name the license. RFD 101c gates what ships.
...
That split is what makes the contract testable. RFD 1028 records a run
...
Five models in the catalog run more than one network. RFD 1025 models
...
RFD 1028 is the worked example. It carries a `Dockerfile`, a
`server.py`, and a `test_input.json`, and RFD 1028 records a run of
