# RFD 1055: A code map, not a copied API reference
...
RFD 1012 deleted the M3 API reference this project's client forked:
...
RFD 1012 gives the reason this page exists at all. RFD 1000 gives
