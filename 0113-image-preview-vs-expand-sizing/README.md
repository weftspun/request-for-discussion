# RFD 0113: Image preview stays 250px, the expand modal stays separate
...
RFD 0000 gives the DRY policy this split rule follows: one token,
one owner, one file. RFD 0112 lists this rule among `rules/`'s guard
