# RFD 0120: Split apps/ into their own repos
...
`apps/` directory (RFD 0076), plus a large vendored browser client
...
RFD 0058 gives the Quadlet deploy this split's `deploy/` move
adapts. RFD 0060 and RFD 0076 give the repo-layout history this RFD
continues.
