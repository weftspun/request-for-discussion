# RFD 106a details: the proprietary-area table and the architecture split
...
this table. RFD 106d gives why: both are abandoned, per RFD 100c and
RFD 100f, and both were fully stripped from the codebase before this
