# RFD 0118: XR embody, view toggle, and Move stay input, not menu state
...
RFD 0010 gives the WebXR session modes this locomotion runs inside.
RFD 0108 gives the floor-anchor placement this embody step assumes.
