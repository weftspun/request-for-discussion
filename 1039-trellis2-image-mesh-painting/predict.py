"""TRELLIS.2 image mesh painting. RFD 1039.

The weights come from the RFD 1038 base image. This file adds the
painting path only.
...
class Output(BaseModel):
    """RFD 1053. A material layer over the mesh, plus the GLB."""
