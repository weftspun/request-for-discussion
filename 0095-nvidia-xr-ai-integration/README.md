...
`:8443` to the GPU host's own `:8088`. RFD 0086's Surface and DGX
Spark are this team's own reference pair, tested with Galaxy XR;
RFD 0119 gives the general requirement.
...
RFD 0086 gives the two-machine topology this integration's proxy
...
Task Manager. RFD 0119 gives the general hardware requirement.
