# RFD 0038: Model image for trellis2_image_to_textured_mesh
...
RFD 0036 gives the model image convention. RFD 0053 gives the asset
format. RFD 0026 gives the memory. RFD 0002 records the pipeline stage
this model fills.
