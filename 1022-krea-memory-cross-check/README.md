# RFD 1022: Krea memory cross-check
...
RFD 1019 gives a rule for the memory. RFD 101a applies that rule to
...
RFD 1019 gives the rule. RFD 101a gives the counts this check cannot
confirm.
