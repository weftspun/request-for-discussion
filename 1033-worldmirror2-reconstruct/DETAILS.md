# RFD 1033 details: the model, the interface, poses, the splat payload
...
COLMAP needs a pose solve before it reconstructs. RFD 1021 records it
...
RFD 1035 makes USD the internal format, and a Gaussian splat has no
