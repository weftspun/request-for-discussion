# RFD 0110 details: file map, context layers, workflows, and carried-over decisions
...
the Surface, API on the DGX (RFD 0086); scp-based sync with no agent
git push (RFD 0086, RFD 0099); RepoResident's own adoption,
