# RFD 0084: The avatar pipeline, image to downloaded VRM
...
Rig alignment is validated against RFD 0083's contract, checked with
...
RFD 0083 gives the rig contract this pipeline validates against.
RFD 0104 gives the separate, user-uploaded-VRM path this pipeline
does not use.
