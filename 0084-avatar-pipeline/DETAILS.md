# RFD 0084 details: the quick path, the task table, and the key files
...
The API's export validates against RFD 0083's contract. After a new
...
this pipeline produces. RFD 0104 gives that path (scene-root
