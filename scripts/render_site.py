...
# The arc under the PEN, per RFC 3061: an OID's URI is `urn:oid:` and the
# dotted notation. Each serial names one RFD for as long as the arc exists,
# so the URN is stable enough to cite like a DOI.
