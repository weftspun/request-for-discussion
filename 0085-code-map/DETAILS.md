# RFD 0085 details: the module table, by group
...
view. RFD 0010 (weftspun-3d-studio's own `decisions/`) gives the
WebXR design.
...
RFD 0012 records the wallet decision. That RFD's own state is
abandoned.
