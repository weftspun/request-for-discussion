# RFD 0083: The API avatar rig export contract
...
RFD 0084 gives the avatar pipeline that produces the GLB this
contract validates. RFD 0104 gives the separate, contract-free VRM
upload path.
