# RFD 1100: Publishing to the Open Metaverse Browser's spatial fabric
...
RFD 1107 gives the separate in-app world-package system this
integration does not touch. RFD 1011 (weftspun-3d-studio's own
