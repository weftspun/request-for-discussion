# RFD 0102: The supported 3DAIGC task catalog, one live source
...
RFD 0004 (weftspun-3d-studio's own `decisions/`) gives the AIGC task
catalog's own original design. RFD 0094 gives the multi-image
routing this catalog's splat and avatar tasks both use. RFD 0100
