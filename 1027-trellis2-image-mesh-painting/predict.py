"""TRELLIS.2 image mesh painting. RFD 1027.

The weights come from the RFD 1026 base image. This file adds the
painting path only.
...
class Output(BaseModel):
    """RFD 1035. A material layer over the mesh, plus the GLB."""
