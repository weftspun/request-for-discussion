...
# RFD 1031 records why this is a domain and not a script.
#
# Two models with no weights of their own here. TripoSplat comes from
# RFD 1034, and TRELLIS.2 comes from RFD 1026.
#
...
defmodule WeftspunImageToWorld do
  ...
  @actions %{
    ...
    # RFD 1035. The splat is one layer, and each prop is a reference
    # under its own prim.
    a_compose_stage: %{
      params: [],
      body: [
