# RFD 1064: Publishing to the Open Metaverse Browser's spatial fabric
...
separate system from this project's own in-app world packages (RFD 106b) and the `/xr` IWSDK lab.
...
RFD 106b gives the separate in-app world-package system this
integration does not touch. RFD 100b (weftspun-3d-studio's own
