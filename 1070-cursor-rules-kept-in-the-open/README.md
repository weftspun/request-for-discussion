# RFD 1070: The Cursor rules, kept in the open
...
One file, `weftspun-moat-protected.mdc`, restates RFD 106a in a more
raw form, and names revenue mechanisms RFD 106a leaves out on
...
`dgx-sync-reminder.mdc` stay too, unedited: RFD 106a gives the
...
rule, and restores once a guard rule converts. RFD 106a gives the
