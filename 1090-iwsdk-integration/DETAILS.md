# RFD 1090 details: packages, tooling, controls, and the work order
...
HTTPS is required for on-device WebXR (RFD 1088).
...
3. Test WebXR on Galaxy XR's own Chrome, on device (HTTPS required; RFD 1088).
...
`https://<PC-LAN-IP>:3000/?nativeFaceRelay=1` (RFD 1105).
