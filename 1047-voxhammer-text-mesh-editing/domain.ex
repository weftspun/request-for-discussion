...
# RFD 1047 records why this is a domain and not a script.
#
# The model carries no weights of its own. It runs on the TRELLIS.2
# backbone from RFD 1038.
#
...
defmodule VoxhammerMeshEditing do
  ...
  @variables %{
    ...
    # RFD 1047 is text, and RFD 1048 is image. One domain serves both.
    mode: %{
      type: :ref,
  ...
  @actions %{
    ...
    # RFD 1053 gives the rule. A muted layer returns the original.
    a_write_layer: %{
      params: [],
      body: [
