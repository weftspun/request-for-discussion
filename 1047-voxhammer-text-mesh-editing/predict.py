"""VoxHammer text mesh editing. RFD 1047.

No weights of its own. The TRELLIS.2 backbone from RFD 1038 comes
from the base image.
...
layer and gets the original back. RFD 1053 gives that rule.
"""
