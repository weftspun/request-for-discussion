# RFD 104c details: the shape, the patch, the bug Playwright caught, and what verified
...
deployed app, in the ports-and-adapters style RFD 1016/0023 already
...
1. The `./`-prefix fix RFD 1049's own `DETAILS.md` already files.
...
- SlugHorn/RFD 104a's caption labels are not part of this change.
