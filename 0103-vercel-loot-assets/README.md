# RFD 0103: Loot assets from a CDN, not a full clone, on Vercel
...
RFD 0093's default asset fetch clones the full `m3-org/loot-assets`
...
bundled, full-clone mode RFD 0093 gives.
...
RFD 0093 gives the bundled-clone default this RFD's CDN mode
replaces. RFD 0098 gives the public-build secret checklist this RFD
also names.
