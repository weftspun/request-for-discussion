# RFD 1037: BEAM workers, local first
...
as Replicate's own terms say, not RFD 103a's zero-trust design.
...
plain Docker images, on RFD 103a's existing Quadlets. vast.ai stays
priced and ready, the next tier once this box stops being enough, per
RFD 103e's Gall's law, not the immediate plan.
...
RFD 1024 gives the image convention. RFD 101b gives the GPU tier.
RFD 1028 records the first worker. RFD 1013 records the core.
