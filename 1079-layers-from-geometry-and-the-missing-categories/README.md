...
RFD 1006 states the task. `2-contract/hm08-partition` proves the disjointness and finds the
...
RFD 1006 places the See-Through stage. RFD 101e lists its component models. RFD 1030 gives
the VoxHammer splice guard this design depends on. RFD 106e gives the handoff file shape the
