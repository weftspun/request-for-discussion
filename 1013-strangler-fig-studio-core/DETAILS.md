# RFD 1013 details: shape, phases, compute, ports, packaging, risk, references
...
the source. A build step writes the JavaScript catalog, and RFD 1010
...
model. A benchmark moves a recommendation. RFD 1010 records that
