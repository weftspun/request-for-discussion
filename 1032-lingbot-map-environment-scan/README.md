# RFD 1032: Model image for lingbot_map_environment_scan
...
runs two phases, and RFD 101a marks its parameter count `unknown`.
...
RFD 1040 records the pivot this RFD yields to. RFD 1035 gives the
stage format this RFD would have used. RFD 1025 gives the
convention. RFD 101b held the budget this measurement would have
closed.
