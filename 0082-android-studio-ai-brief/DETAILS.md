# RFD 0082 details: data flow, implementation status, constraints, and testing
...
`src/library/xrExpressionTrackingDriver.js`. RFD 0096 gives the full
spec.
...
| RFD 0096 | Spec links, the payload contract |
| RFD 0105 | WebXR expression notes, remote logging |
